<div class="wrap">
    <div class="supsystic-plugin">
        ...
        <section class="supsystic-content">
			...
			<?php
				// We will show overview - on our plugin main page
				$addContainerClass = $this->activeTab == 'main_page' ? 'overview' : $this->activeTab;
			?>
            <div class="supsystic-container supsystic-<?php echo $addContainerClass;?>">
