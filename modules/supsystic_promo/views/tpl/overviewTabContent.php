	...
	<div class="supsystic-item supsystic-panel">
		<div id="containerWrapper">
			<div class="supsistic-half-side-box" style="border-right: 1px solid rgba(164, 170, 172, 0.28);">
				<h3><?php _e('FAQ and Documentation', SLN_LANG_CODE)?></h3>
				<div class="faq-list">
					...
					<a target="_blank" class="button button-primary button-hero" href="<?php echo $this->mainLink?>#faq" style="float: right;">
						<i class="fa fa-info-circle"></i>
						<?php _e('Check all FAQs', SLN_LANG_CODE)?>
					</a>
					<div style="clear: both;"></div>
				</div>
				<?php /*?><div class="video">
					<h3><?php _e('Video tutorial', SLN_LANG_CODE)?></h3>
				...
				<div class="server-settings">
					<h3><?php _e('Server Settings', SLN_LANG_CODE)?></h3>
			...
			<div class="supsistic-half-side-box" style="padding-left: 20px;">
				<div class="supsystic-overview-news">
					<h3><?php _e('News', SLN_LANG_CODE)?></h3>
					...
					<a href="<?php echo $this->mainLink?>" class="button button-primary button-hero" style="float: right; margin-top: 10px;">
						<i class="fa fa-info-circle"></i>
						<?php _e('All news and info', SLN_LANG_CODE)?>
					</a>
					<div style="clear: both;"></div>
				</div>
				<div class="overview-contact-form">
					<h3><?php _e('Contact form', SLN_LANG_CODE)?></h3>
					<form id="form-settings">
						<table class="contact-form-table">
							...
							<tr>
								...
								<td>
									<?php echo htmlSln::$htmlType($fName, $htmlParams)?>
								</td>
							</tr>
							<?php }?>
							<tr>
								<th scope="row" colspan="2">
									<?php echo htmlSln::hidden('mod', array('value' => 'supsystic_promo'))?>
									<?php echo htmlSln::hidden('action', array('value' => 'sendContact'))?>
									<button class="button button-primary button-hero" style="float: right;">
										<i class="fa fa-upload"></i>
										<?php _e('Send email', SLN_LANG_CODE)?>
									</button>
									<div style="clear: both;"></div>
								</th>
							</tr>
					...
					<div id="form-settings-send-msg" style="display: none;">
						...
						<?php _e('Your email was send, we will try to respond to you as soon as possible. Thank you for support!', SLN_LANG_CODE)?>
					</div>
				</div>
			</div>
			<div style="clear: both;"></div>
